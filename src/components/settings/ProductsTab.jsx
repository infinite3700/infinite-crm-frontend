...
const ProductsTab = () => {
  ...
  const canEdit = hasPermission(currentUser, PERMISSIONS.SETTINGS_MANAGE);
  ...
  return (
    <div className="space-y-6 sm:space-y-8">
      ...
      <div>
        ...
        <p className="section-subtitle">Manage your product categories and products catalog</p>
      </div>
          ...
          <Card className="card-enhanced">
            <CardHeader className="border-b border-gray-100 bg-gradient-to-r from-blue-50 to-purple-50 p-4 sm:p-6">
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                ...
                <CanAccess permission={PERMISSIONS.SETTINGS_MANAGE}>
                  <Button
                    onClick={() =>
                      setDialogState({
                        isOpen: true,
      ...
      {dialogState.isOpen &&
        (dialogState.type === 'add-category' || dialogState.type === 'edit-category') && (
                ...
                >
                  ...
                  <div className="flex items-center space-x-2">
                    <input
                      ...
                      onChange={(e) =>
                        setCategoryForm({ ...categoryForm, status: e.target.checked })
                      }
                      className="h-4 w-4 text-blue-600 rounded border-gray-300 focus:ring-blue-500"
                    />
                    <Label
                      htmlFor="modal-categoryStatus"
      ...
      {dialogState.isOpen &&
        (dialogState.type === 'add-product' || dialogState.type === 'edit-product') && (
          <div className="fixed inset-0 z-50 flex items-center justify-center">
            {/* Backdrop */}
            <div
              className="absolute inset-0 bg-black/50 backdrop-blur-sm"
